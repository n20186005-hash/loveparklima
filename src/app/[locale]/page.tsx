...
const MAPS_URL = "https://maps.app.goo.gl/f3hGnVCU134Ugba38";

const GOOGLE_REVIEWS = [
  { name: "María G.", avatar: "MG", rating: 5, date: "2024-11-20", text: "El Parque del Amor es un lugar muy romántico. Ideal para ver la puesta del sol en Miraflores. Los mosaicos son hermosos." },
  { name: "John S.", avatar: "JS", rating: 5, date: "2024-10-15", text: "Love Park is a must-visit in Lima! The Kiss Sculpture is iconic and the view of the Pacific Ocean is breathtaking. Perfect for couples." },
  { name: "Carlos R.", avatar: "CR", rating: 5, date: "2024-09-10", text: "Un lugar especial en Miraflores. El Parque del Amor tiene una energía única. Los azulejos de colores son una obra de arte." },
  { name: "李小美", avatar: "李", rating: 5, date: "2024-08-25", text: "爱情公园真的很浪漫！亲吻雕塑非常有名，马赛克长椅色彩斑斓。利马看日落的最佳地点！" },
  { name: "Ana P.", avatar: "AP", rating: 5, date: "2024-07-18", text: "Hermoso parque con vista al mar. El Parque del Amor es perfecto para una caminata por el malecón de Miraflores." },
  { name: "Michael T.", avatar: "MT", rating: 5, date: "2024-06-05", text: "Fantastic park in Lima! The mosaic benches are incredible and the ocean view is amazing. A great spot for photos and romance." }
];
    ...
    <section className="hero">
      ...
      <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}>
        <div className="hero-meta">
          ...
          <div className="hero-reviews">30,706 {t.rating.reviews} · {t.rating.source}</div>
        </div>
      </a>
    </section>
  );
      ...
      <ScrollReveal>
        <div className="location-section">
          <div className="location-map-container">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3902.547747015476!2d-77.02970492373255!3d-12.126438853306795!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c7c0e2c7d1d1%3A0x8f8f8f8f8f8f8f8f!2sLove%20Park%2C%20Miraflores!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
              width="800"
              height="600"
              style={{ border: 0 }}
              allowFullScreen
